...
// The support generated by Cura is too thin and collapses midway.
// Oddly enough, it self-restores. But the little filaments are
// scattered everywhere and may affect the quality.
module ejector_pedestal () {
    lower_h = 74.0;
    height = 71;
    translate([2.3, -3.4, height/2 - lower_h])
        cylinder(height, 6, 4.2, center=true);
    translate([0, -12.0, lower_h*-1])
        cube([1.0, 8.0, 1.0]);
}
